 ...
 */
class getAnnotatedAppEntityExamentestApiPlatformDoctrineOrmFilterSearchFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'annotated_app_entity_examentest_api_platform_doctrine_orm_filter_search_filter' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['annotated_app_entity_examentest_api_platform_doctrine_orm_filter_search_filter'])) {
            return $container->privates['annotated_app_entity_examentest_api_platform_doctrine_orm_filter_search_filter'];
        }

        return $container->privates['annotated_app_entity_examentest_api_platform_doctrine_orm_filter_search_filter'] = new \ApiPlatform\Doctrine\Orm\Filter\SearchFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a, ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container)), ($container->privates['logger'] ?? self::getLoggerService($container)), ['id' => 'word_start', 'patient.id' => 'exact', 'nom_patient' => 'word_start', 'maladie' => 'word_start', 'date_test' => 'word_start', 'created_at' => 'word_start', 'nom_test' => 'word_start', 'user' => 'word_start', 'patient' => 'word_start'], NULL, ($container->privates['serializer.name_converter.metadata_aware'] ?? self::getSerializer_NameConverter_MetadataAwareService($container)));
    }
}
