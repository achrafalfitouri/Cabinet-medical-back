 ...
 */
class getTestcrudRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TestcrudRepository' shared autowired service.
     *
     * @return \App\Repository\TestcrudRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TestcrudRepository.php';

        return $container->privates['App\\Repository\\TestcrudRepository'] = new \App\Repository\TestcrudRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
