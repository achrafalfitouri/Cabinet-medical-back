 ...
 */
class getExamenresultatRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ExamenresultatRepository' shared autowired service.
     *
     * @return \App\Repository\ExamenresultatRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ExamenresultatRepository.php';

        return $container->privates['App\\Repository\\ExamenresultatRepository'] = new \App\Repository\ExamenresultatRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
