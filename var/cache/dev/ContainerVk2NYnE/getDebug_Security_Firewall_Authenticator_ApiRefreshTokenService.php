 ...
 */
class getDebug_Security_Firewall_Authenticator_ApiRefreshTokenService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'debug.security.firewall.authenticator.api_refresh_token' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['debug.security.firewall.authenticator.api_refresh_token'])) {
            return $container->privates['debug.security.firewall.authenticator.api_refresh_token'];
        }

        return $container->privates['debug.security.firewall.authenticator.api_refresh_token'] = new \Symfony\Component\Security\Http\Authenticator\Debug\TraceableAuthenticatorManagerListener(new \Symfony\Component\Security\Http\Firewall\AuthenticatorManagerListener(new \Symfony\Component\Security\Http\Authentication\AuthenticatorManager([$a], ($container->privates['security.token_storage'] ?? self::getSecurity_TokenStorageService($container)), ($container->privates['debug.security.event_dispatcher.api_refresh_token'] ?? $container->load('getDebug_Security_EventDispatcher_ApiRefreshTokenService')), 'api_refresh_token', ($container->privates['logger'] ?? self::getLoggerService($container)), true, true, [])));
    }
}
