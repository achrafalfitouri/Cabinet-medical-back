...
class getAnnotatedAppEntityUserApiPlatformDoctrineOrmFilterSearchFilterService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['annotated_app_entity_user_api_platform_doctrine_orm_filter_search_filter'] = new \ApiPlatform\Doctrine\Orm\Filter\SearchFilter(($container->services['doctrine'] ?? self::getDoctrineService($container)), $a, ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container)), ($container->privates['logger'] ?? self::getLoggerService($container)), ['id' => 'word_start', 'email' => 'word_start', 'roles' => 'word_start', 'password' => 'word_start', 'nom' => 'word_start', 'adresse' => 'word_start', 'tel' => 'word_start', 'created_at' => 'word_start', 'rendezvouses' => 'word_start', 'patients' => 'word_start', 'ordonances' => 'word_start', 'medicaments' => 'word_start', 'categoriems' => 'word_start', 'examentests' => 'word_start', 'examenresultats' => 'word_start'], NULL, ($container->privates['serializer.name_converter.metadata_aware'] ?? self::getSerializer_NameConverter_MetadataAwareService($container)));
    }
}
