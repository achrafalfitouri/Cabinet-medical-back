 ...
 */
class getCategoriemRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CategoriemRepository' shared autowired service.
     *
     * @return \App\Repository\CategoriemRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CategoriemRepository.php';

        return $container->privates['App\\Repository\\CategoriemRepository'] = new \App\Repository\CategoriemRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
