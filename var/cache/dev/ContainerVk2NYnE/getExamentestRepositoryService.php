 ...
 */
class getExamentestRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ExamentestRepository' shared autowired service.
     *
     * @return \App\Repository\ExamentestRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ExamentestRepository.php';

        return $container->privates['App\\Repository\\ExamentestRepository'] = new \App\Repository\ExamentestRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
