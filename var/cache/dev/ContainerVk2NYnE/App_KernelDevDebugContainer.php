...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sx0Y9RWdHx', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\CategoriemRepository' => ['privates', 'App\\Repository\\CategoriemRepository', 'getCategoriemRepositoryService', true],
            'App\\Repository\\ExamenresultatRepository' => ['privates', 'App\\Repository\\ExamenresultatRepository', 'getExamenresultatRepositoryService', true],
            'App\\Repository\\ExamentestRepository' => ['privates', 'App\\Repository\\ExamentestRepository', 'getExamentestRepositoryService', true],
            ...
            'App\\Repository\\TestcrudRepository' => ['privates', 'App\\Repository\\TestcrudRepository', 'getTestcrudRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\CategoriemRepository' => '?',
            'App\\Repository\\ExamenresultatRepository' => '?',
            'App\\Repository\\ExamentestRepository' => '?',
            ...
            'App\\Repository\\TestcrudRepository' => '?',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.view', [#[\Closure(name: 'App\\EventSubscriber\\PasswordSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\PasswordSubscriber'] ?? $container->load('getPasswordSubscriberService')), 'hashPassword'], 33);
    ...
    /**
     * Gets the private '.service_locator.Vnsvu1n' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_Vnsvu1nService($container)
    {
        return $container->privates['.service_locator.Vnsvu1n'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'security.firewall.map.context.api_refresh_token' => ['privates', 'security.firewall.map.context.api_refresh_token', 'getSecurity_Firewall_Map_Context_ApiRefreshTokenService', true],
            ...
            'security.firewall.map.context.api_refresh_token' => '?',
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('BmZubiLBpr', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('cB0kesHIUI', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xzrJFD9EW1', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getApiPlatform_FilterLocatorService($container)
    {
        return $container->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'annotated_app_entity_categoriem_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_categoriem_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityCategoriemApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_examenresultat_api_platform_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_examenresultat_api_platform_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityExamenresultatApiPlatformDoctrineOrmFilterOrderFilterService', true],
            'annotated_app_entity_examenresultat_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_examenresultat_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityExamenresultatApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_examentest_api_platform_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_examentest_api_platform_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityExamentestApiPlatformDoctrineOrmFilterOrderFilterService', true],
            'annotated_app_entity_examentest_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_examentest_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityExamentestApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_medicament_api_platform_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_medicament_api_platform_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityMedicamentApiPlatformDoctrineOrmFilterOrderFilterService', true],
            'annotated_app_entity_medicament_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_medicament_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityMedicamentApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_ordonance_api_platform_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_ordonance_api_platform_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityOrdonanceApiPlatformDoctrineOrmFilterOrderFilterService', true],
            'annotated_app_entity_ordonance_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_ordonance_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityOrdonanceApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_patient_api_platform_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_patient_api_platform_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityPatientApiPlatformDoctrineOrmFilterOrderFilterService', true],
            'annotated_app_entity_patient_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_patient_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityPatientApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_rendezvous_api_platform_doctrine_orm_filter_date_filter' => ['privates', 'annotated_app_entity_rendezvous_api_platform_doctrine_orm_filter_date_filter', 'getAnnotatedAppEntityRendezvousApiPlatformDoctrineOrmFilterDateFilterService', true],
            'annotated_app_entity_rendezvous_api_platform_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_rendezvous_api_platform_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityRendezvousApiPlatformDoctrineOrmFilterOrderFilterService', true],
            'annotated_app_entity_rendezvous_api_platform_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_rendezvous_api_platform_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityRendezvousApiPlatformDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_user_api_platform_doctrine_orm_filter_order_filter' => ['privates', 'annotated_app_entity_user_api_platform_doctrine_orm_filter_order_filter', 'getAnnotatedAppEntityUserApiPlatformDoctrineOrmFilterOrderFilterService', true],
            ...
            'annotated_app_entity_categoriem_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_examenresultat_api_platform_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_examenresultat_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_examentest_api_platform_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_examentest_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_medicament_api_platform_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_medicament_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_ordonance_api_platform_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_ordonance_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_patient_api_platform_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_patient_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_rendezvous_api_platform_doctrine_orm_filter_date_filter' => '?',
            'annotated_app_entity_rendezvous_api_platform_doctrine_orm_filter_order_filter' => '?',
            'annotated_app_entity_rendezvous_api_platform_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_user_api_platform_doctrine_orm_filter_order_filter' => '?',
    ...
    protected static function getApiPlatform_Symfony_IriConverterService($container)
    {
        ...
        return $container->privates['api_platform.symfony.iri_converter'] = new \ApiPlatform\Symfony\Routing\IriConverter($a, ($container->privates['api_platform.router'] ?? self::getApiPlatform_RouterService($container)), new \ApiPlatform\Api\IdentifiersExtractor($b, $c, ($container->privates['api_platform.metadata.property.name_collection_factory.cached'] ?? self::getApiPlatform_Metadata_Property_NameCollectionFactory_CachedService($container)), ($container->privates['api_platform.metadata.property.metadata_factory.cached'] ?? self::getApiPlatform_Metadata_Property_MetadataFactory_CachedService($container)), ($container->privates['property_accessor'] ?? self::getPropertyAccessorService($container))), $c, $b, ($container->privates['api_platform.uri_variables.converter'] ?? self::getApiPlatform_UriVariables_ConverterService($container)), ($container->privates['api_platform.symfony.iri_converter.skolem'] ?? self::getApiPlatform_Symfony_IriConverter_SkolemService($container)), new \ApiPlatform\Metadata\Operation\Factory\OperationMetadataFactory(($container->privates['api_platform.metadata.resource.name_collection_factory.cached'] ?? self::getApiPlatform_Metadata_Resource_NameCollectionFactory_CachedService($container)), $b));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('RTrRYn8Wf8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UE7g4k3TU8', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        $a = ($container->privates['.service_locator.Vnsvu1n'] ?? self::get_ServiceLocator_Vnsvu1nService($container));
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            yield 'security.firewall.map.context.api_refresh_token' => ($container->privates['.security.request_matcher.N3tktls'] ?? $container->load('get_Security_RequestMatcher_N3tktlsService'));
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'lexik_jwt_authentication.token_ttl' => 60,
